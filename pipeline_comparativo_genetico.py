#!/usr/bin/env python3
"""
Pipeline Comparativo - Inicial vs Genético
Genera análisis completo del método Algoritmo Genético
"""
...
def main():
    """Ejecuta pipeline comparativo para Genético"""
    ...
    csv_genetico = "/Users/lic.ing.jesusolvera/Documents/PROYECTOS PERSONALES/Sistema-Salones-ISC/datos_estructurados/04_Horario_Optimizado_Genetico.csv"
    nombre_comparativa = "03_inicial_vs_genetico"
    carpeta_salida = "/Users/lic.ing.jesusolvera/Documents/PROYECTOS PERSONALES/Sistema-Salones-ISC/comparativas/03_inicial_vs_genetico"
    ...
    analizador = AnalizadorComparativoExpandido(csv_inicial, csv_genetico, carpeta_salida)
    ...
    generador_pdf = GeneradorReportePDF(csv_inicial, csv_genetico, carpeta_salida, pdf_path, nombre_metodo="Algoritmo Genético")
    ...
    generar_excel_formateado(csv_genetico, carpeta_salida, "Horario_Optimizado_Genetico")
    ...
    # RESUMEN FINAL
    print("="*80)
    print("✅ COMPARATIVA GENÉTICO COMPLETADA")
    print("="*80)
    ...
    print(f"\n🎯 Método Algoritmo Genético documentado y analizado")
    print(f"\n📋 Próximos pasos:")
    print(f"   • ILP (Programación Lineal Entera)")
    print(f"   • Comparativa final de todos los métodos\n")
