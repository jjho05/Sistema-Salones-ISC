...
def asignar_forzadamente(self, df, clases_ordenadas):
    ...
    for clase_info in clases_ordenadas:
        ...
        if key in ocupacion:
            ...
            if not exito:
                print(f"  No se pudo asignar clase {idx}")
                continue
...
def cargar_indices_inmutables(self):
    ...
    try:
        ...
        print("  No se encontró archivo de índices inmutables")
\end{verbatim}
...
"""
    ...
    if cumplimiento_final == 100.0:
        ...
        reporte += f"\n  Cumplimiento {cumplimiento_final}% < 100%\n"
...
2. **Rendimiento**
   ...
   -  Sin caché de datos
   -  Carga completa en cada request
   -  No hay paginación
...
4. **Estabilidad**
   ...
   -  Puede fallar con datos inconsistentes
...
## 1⃣ Prueba de Normalidad (Shapiro-Wilk)
...
## 4⃣ Tamaños de Efecto (Cohen's d)
